...
fn main() {
    println!("# Formula corpus catalog\n");
    println!("Side-by-side listing of the roundtrip-verified formulas in");
    ...
    variance();
    bayes_theorem();
    println!("## Structural stress tests\n");
    rotation_matrix();
    matrix_exponential();
    nested_matrices();
    continued_fraction();
    ...
    println!("## Arrows and text\n");
    arrows_and_text();
    println!("## Limit-taking functions\n");
    limit_funcs();
    println!("## Braces\n");
    braces_over_under();
    // Ends the file without a trailing blank line (markdownlint MD012).
    println!("<!-- regenerated by examples/catalog.rs -->");
}
